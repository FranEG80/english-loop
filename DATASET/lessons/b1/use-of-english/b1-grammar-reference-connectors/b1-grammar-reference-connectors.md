...
learningObjectives:
  ...
  - "Reconocer artículos, auxiliares, pronombres, conectores y preposiciones previsibles."
prerequisites:
...
1. **I bought a notebook because the old one was full.** — Compré un cuaderno porque el anterior estaba lleno.
2. **The keys were on the table, where I had left them.** — Las llaves estaban en la mesa, donde las había dejado.
3. **She has worked here for three years.** — Lleva tres años trabajando aquí.
4. **Although it was late, we finished the report.** — Aunque era tarde, terminamos el informe.
...
1. Completa: `I have been studying English ___ 2022.`
   - Respuesta: `since`
   - Explicación: `2022` es un punto de inicio.
2. Completa: `She stayed home ___ she felt ill.`
   - Respuesta: `because`
   - Explicación: La segunda parte explica la causa de quedarse en casa.
