---
schemaVersion: 1.0.0
id: b1-use-of-english-fixed-expressions
title: "Expresiones fijas B1 para hablar con naturalidad"
level: B1
category: use-of-english
topic: b1-fixed-expressions
subtopics:
  - b1-fixed-expressions
difficulty: 3
estimatedMinutes: 24
learningObjectives:
  - "Reconocer expresiones fijas frecuentes en situaciones cotidianas."
  - "Elegir una expresión por su función comunicativa y colocación completa."
  - "Usar marcos fijos para pedir, ofrecer, disculparse y reaccionar."
prerequisites:
...
Las expresiones fijas son combinaciones que los hablantes recuperan como una unidad: *by the way*, *in a hurry*, *of course* o *Would you mind...?*. Aprenderlas completas ayuda a sonar natural y evita traducir palabra por palabra.

# Objetivos

- Reconocer expresiones de tiempo, opinión, cortesía y reacción.
...
3. Reaccionar: *That sounds like a good idea.*
...
1. **I was in a hurry, so I left without breakfast.**
2. **By the way, your parcel has arrived.**
3. **We got there just in time for the last bus.**
4. **I made a mistake in the address.**
5. **Would you mind turning the music down?**
6. **As far as I know, the meeting is still on.**
