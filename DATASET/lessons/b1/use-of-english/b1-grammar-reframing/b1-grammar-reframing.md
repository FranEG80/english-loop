...
estimatedMinutes: 30
learningObjectives:
  - "Reformular comparaciones, pasivas, discurso indirecto y patrones verbales conservando significado."
  - "Producir respuestas dentro de conjuntos finitos y límites de palabras."
prerequisites:
...
Reescribir una oración significa expresar la misma idea con una estructura diferente. La frase nueva debe conservar el tiempo, la persona, la negación, la cantidad y la relación lógica de la original.
...
1. **The shop is cheaper than the market. → The market is not as cheap as the shop.** — El mercado no es tan barato como la tienda.
2. **Someone has stolen my bike. → My bike has been stolen.** — Me han robado la bicicleta.
3. **“I am busy,” Leo said. → Leo said that he was busy.** — Leo dijo que estaba ocupado.
4. **I started studying here in 2022. → I have studied here since 2022.** — Estudio aquí desde 2022.

# Errores frecuentes

- ❌ *The letter was wrote yesterday.*
- ✅ *The letter was written yesterday.*
- ❌ *Mia told that she was tired.*
...
1. Reformula: `The blue car is cheaper than the red car.` → `The red car is not ___ the blue car.`
   ...
   - Explicación: Es la transformación equivalente del comparativo.
2. Reformula: `“I can help,” Ana said.` → `Ana said that she ___ help.`
   - Respuesta: `could`
   - Explicación: En estilo indirecto, `can` suele retroceder a `could`.
