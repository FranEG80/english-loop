---
schemaVersion: 1.0.0
id: b1-phrasal-verbs-everyday-actions
title: "Phrasal verbs para acciones cotidianas"
level: B1
category: phrasal-verbs
topic: b1-phrasal-everyday-actions
subtopics:
  - b1-phrasal-everyday-actions
difficulty: 2
estimatedMinutes: 30
learningObjectives:
  - "Usar phrasal verbs frecuentes para rutinas, ropa, aparatos y cuidado."
  - "Distinguir partículas separables e inseparables con pronombres."
prerequisites:
...
Los phrasal verbs aparecen constantemente al hablar de rutinas, objetos y tareas. Aprenderás a elegir la partícula por el significado y a colocar correctamente el objeto.

# Objetivos

- Comprender verbos como *get up*, *put on*, *turn off* y *look after*.
