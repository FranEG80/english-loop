---
schemaVersion: 1.0.0
id: b1-writing-story-sequencing
title: "Secuenciar una historia B1"
level: B1
category: guided-writing
topic: b1-writing-story-sequencing
subtopics:
  - b1-writing-story-sequencing
difficulty: 3
estimatedMinutes: 28
learningObjectives:
...
- **At first**, the station was quiet. **While I was waiting**, the lights went out. **After that**, a member of staff showed us another platform. **Finally**, the train arrived.
- *I had left my phone at home* explica algo anterior a otra acción pasada.
- *By the time we reached the campsite*, it had started to rain.
