---
schemaVersion: 1.0.0
id: b2-reading-attitude-tone
title: "Reconocer actitud, tono y grado de certeza"
level: B2
category: reading
topic: b2-reading-attitude-tone
subtopics:
  - b2-reading-attitude-tone
difficulty: 3
estimatedMinutes: 25
learningObjectives:
  - "Reconocer actitud, tono, reservas y grado de certeza."
  - "Relacionar elecciones léxicas con aprobación, crítica, ironía moderada o cautela."
prerequisites:
...
El tono de un texto depende de más que palabras positivas o negativas. Practicarás cómo interpretar reservas, intensidad, ironía moderada y grados de certeza a partir del vocabulario y de la estructura del discurso.

# Objetivos

- Identificar aprobación, crítica, neutralidad y cautela.
...
1. **The results are encouraging, although more data is needed.** — Optimismo cauteloso.
2. **The reviewer dismisses the claim as unrealistic.** — Crítica clara.
3. **The “quick” solution required three months.** — Las comillas pueden señalar ironía contextual.

# Errores frecuentes

- ❌ Leer *could* como una afirmación segura.
- ✅ Interpretarlo como posibilidad o reserva.
...
1. **The plan is promising, but its costs remain unclear.** ¿Qué actitud expresa?
   ...
   - Explicación: el autor valora el plan, pero mantiene una reserva explícita.
