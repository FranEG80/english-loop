---
schemaVersion: 1.0.0
id: b2-reading-gist-detail-inference
title: "Idea general, detalle e inferencia en textos B2"
level: B2
category: reading
topic: b2-reading-gist-detail-inference
subtopics:
  - b2-reading-gist-detail-inference
difficulty: 3
estimatedMinutes: 25
learningObjectives:
  - "Integrar información distribuida para inferir conclusiones justificadas."
  - "Distinguir inferencia textual de suposición externa."
prerequisites:
...
En textos B2, la respuesta rara vez aparece con las mismas palabras que la pregunta. Aprenderás a combinar pistas distribuidas, distinguir detalle de idea general y justificar una inferencia sin inventar información.

# Objetivos

- Integrar dos o más pistas del texto para obtener una conclusión.
...
1. **The scheme began with three volunteers and later attracted local businesses.** — Se puede inferir que creció gradualmente.
2. **The article compares two methods but recommends neither.** — El propósito es comparar, no persuadir.
3. **Only one participant mentioned cost.** — No se puede concluir que el coste fuera el problema de todos.

# Errores frecuentes

- ❌ Elegir una opción que repite una palabra del texto, aunque cambie la relación lógica.
- ✅ Comprobar que la paráfrasis mantiene causa, alcance y tono.
...
1. **The café reduced its menu, shortened opening hours and hired fewer staff.** ¿Qué inferencia es segura?
   ...
   - Explicación: las tres decisiones apuntan a controlar gastos.
