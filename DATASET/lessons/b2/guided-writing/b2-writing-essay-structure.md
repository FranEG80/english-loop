---
schemaVersion: 1.0.0
id: b2-writing-essay-structure
title: "Organizar un ensayo argumentativo B2"
level: B2
category: guided-writing
topic: b2-writing-essay-structure
subtopics:
  - b2-writing-essay-structure
difficulty: 3
estimatedMinutes: 30
learningObjectives:
  - "Organizar introducción, argumentos, contraargumento y conclusión."
  - "Seleccionar tesis y topic sentences que respondan exactamente a la tarea."
prerequisites:
  - b1-writing-opinion-article
  - b2-reading-argument-evidence
frameworkRefs:
...
Aprenderás a convertir una postura en un ensayo organizado, con argumentos desarrollados y una conclusión que responda a la pregunta.

# Objetivos

- Formular una tesis que cubra toda la tarea.
...
- ❌ Introducir una idea nueva en la conclusión.
- ✅ Sintetizar los argumentos ya desarrollados.
