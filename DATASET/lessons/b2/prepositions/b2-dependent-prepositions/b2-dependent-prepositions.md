---
schemaVersion: 1.0.0
id: b2-dependent-prepositions
title: "Preposiciones dependientes B2"
level: B2
category: prepositions
topic: b2-dependent-prepositions
subtopics:
...
relatedLessonIds:
  - b1-dependent-prepositions
  - b2-prepositional-fixed-phrases
tags:
  - b2
  - prepositions
...
- The supplier must **comply with** the new safety code.
- The team is **capable of** handling a larger workload.
- There has been a sharp **increase in** online applications.
- We need **access to** the original records.
