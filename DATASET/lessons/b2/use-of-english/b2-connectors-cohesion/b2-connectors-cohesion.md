...
**Although / despite:** conjunción seguida de oración frente a preposición seguida de nombre o gerundio. **Because / because of:** oración frente a nombre o grupo nominal. **Which / what:** relativo que retoma algo frente a palabra que introduce una cosa no especificada. **Since / for:** punto inicial frente a duración.

# Ejemplos

1. **The project succeeded because the team planned carefully.**
2. **Despite the delay, the visitors remained patient.**
3. **The device, which was designed locally, uses little energy.**
4. **No sooner had we arrived than the lights went out.**
5. **The result depends on how the data is collected.**

# Errores frecuentes

- ❌ *Although of the rain, we continued.* ✅ *Despite the rain, we continued.*
- ❌ *The reason is because of prices rose.* ✅ *The reason is that prices rose.*
- ❌ Omitir el auxiliar en una pasiva. ✅ *The bridge was built in 1920.*
- ❌ Repetir el nombre en lugar del pronombre relativo. ✅ Revisar qué elemento retoma *which* o *those*.
...
1. Contrast before a noun: **despite**.
2. Reason before a clause: **because**.
