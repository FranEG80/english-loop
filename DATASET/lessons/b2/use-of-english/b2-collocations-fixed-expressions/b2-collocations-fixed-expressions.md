...
- *In the end* habla del resultado; *in the long run* habla de consecuencias futuras.
- *Take for granted* significa no valorar algo porque se considera seguro; *make sure* significa comprobarlo.
- *At short notice* implica poco tiempo de preparación; *in advance* implica anticipación.
...
- ❌ *in a long run*.
- ✅ *in the long run*.
- ❌ *take granted the service*.
- ✅ *take the service for granted*.
- ❌ *under no circumstance*.
- ✅ *under no circumstances* en la expresión establecida.

# Variación y registro

- Algunas expresiones permiten variación de número o de pronombre: *take it for granted* y *take basic services for granted*.
- La parte fija debe conservarse, pero el objeto se adapta al significado de la frase.
