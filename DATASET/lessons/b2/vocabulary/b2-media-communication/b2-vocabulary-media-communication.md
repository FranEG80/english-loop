---
schemaVersion: 1.0.0
id: b2-vocabulary-media-communication
title: "Medios, comunicación y lectura crítica"
level: B2
category: vocabulary
topic: b2-media-communication
subtopics:
  - b2-media-communication
difficulty: 4
estimatedMinutes: 28
learningObjectives:
  - "Analizar fuentes, cobertura, audiencia, persuasión y desinformación."
  - "Describir afirmaciones, pruebas, tono, sesgo y difusión con precisión."
  - "Evaluar la fiabilidad de un mensaje antes de compartirlo."
prerequisites:
...
Una persona con nivel B2 necesita algo más que *news* y *information* para analizar cómo se comunica una idea. Esta lección trabaja *source*, *coverage*, *headline*, *audience*, *claim*, *evidence*, *bias*, *tone*, *misinformation* y *fact-checking* en contextos de prensa, redes, podcasts y comunicación pública.

# Objetivos

- Distinguir noticia, opinión, comentario y publicidad.
- Relacionar una afirmación con la evidencia que la respalda.
...
1. **The headline attracted attention but did not tell the whole story.**
2. **The journalist asked the minister to provide evidence for the claim.**
3. **The podcast uses a conversational tone to reach younger listeners.**
4. **Readers should verify an image before sharing it.**
5. **The report gives both sides of the debate, although its conclusion is critical.**
6. **A misleading statistic can influence public opinion.**
