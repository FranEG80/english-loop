        ...
        for (const activity of input.activities) {
          ...
          const version = await tx.activityVersion.create({
            data: {
              ...
              gapText: activity.gapText ?? null,
              gapLayout: activity.gapLayout ?? null,
              passage: activity.passage ?? null,
              cueWord: activity.cueWord ?? null,
              keyWord: activity.keyWord ?? null,
              firstSentence: activity.firstSentence ?? null,
              optionsOrdered: activity.optionsOrdered ?? false,
              game: activity.game ?? null,
              cardsData: activity.cards ? JSON.stringify(activity.cards) : null,
              roundsData: activity.rounds ? JSON.stringify(activity.rounds) : null,
