import type { ActivityCatalogPort, ActivityListFilters, CatalogMetadata, CatalogMetadataPort, LessonCatalogPort, LessonListFilters, TaxonomyCatalogPort } from "@/core/content/ports/catalog-ports";
...
export class D1CatalogAdapter implements LessonCatalogPort, ActivityCatalogPort, TaxonomyCatalogPort, CatalogMetadataPort {
