...
const input: CatalogSeedInput = {
  ...
  activities: [{ id: "activity-1", checksum: "activity", type: "choice", skillFocus: "fill_blank", evaluatorStrategy: "single_option", level: "B1", category: "grammar", topic: "grammar", subtopic: "present", difficulty: 1, instructions: "Choose", prompt: "Prompt", explanation: "Explanation", tags: [], lessonIds: ["lesson-1"], taxonomyNodeIds: ["grammar"], estimatedSeconds: 30, evaluator: { strategy: "single_option", correctOptionId: "correct" }, options: [{ id: "correct", text: "Correct", feedback: "Correct" }], tokens: [], pairs: [], expectedAnswers: [{ gapId: null, answer: "correct", position: 0 }], status: "published" }],
};
