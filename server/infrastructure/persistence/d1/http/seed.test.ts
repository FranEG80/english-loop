...
const lesson = [{ id: "lesson-1", checksum: "checksum", level: "B1", category: "grammar", taxonomyNodeId: "grammar", title: "Lesson", summary: "Summary", explanation: "Explanation", examples: [], commonMistakes: [], tags: [], difficulty: 1, contentVersion: 1, status: "published" }];
