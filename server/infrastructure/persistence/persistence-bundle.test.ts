  ...
  it("keeps Prisma composition for non-D1 providers", async () => {
    ...
    const bundle = createPersistenceBundle({
      ...
      config: {
        ...
        attemptRateLimitWindowMs: 60_000, attemptRateLimitMax: 30, authRateLimitWindowMs: 60_000, authRateLimitMax: 10, prismaTransactionRetryMax: 2,
      },
    });
